            ...
            <section className="whyhire">
                <div className="container">
                    <div className="row justify-content-center align-items-center">
                        {/* Left Column - Content */}
                        <div className="col-12 col-lg-7 d-flex justify-content-center align-items-center flex-column whyhirecontent text-center text-lg-start">
                            <h2 className="SectionHeading whitetext mb-5 ml-[50px]">
                                Why hire from LumioAI talent network?
                            </h2>
                            <p className="paratext whitetext mb-5 ml-[50px]">
